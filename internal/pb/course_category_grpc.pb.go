...
type CategoryServiceClient interface {
	...
	GetCategoriesByDescription(ctx context.Context, in *CategoryGetRequest, opts ...grpc.CallOption) (*CategoryList, error)
}
...
func (c *categoryServiceClient) GetCategoriesByDescription(ctx context.Context, in *CategoryGetRequest, opts ...grpc.CallOption) (*CategoryList, error) {
	out := new(CategoryList)
	err := c.cc.Invoke(ctx, "/pb.CategoryService/GetCategoriesByDescription", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	...
	GetCategoriesByDescription(context.Context, *CategoryGetRequest) (*CategoryList, error)
...
func (UnimplementedCategoryServiceServer) GetCategoriesByDescription(context.Context, *CategoryGetRequest) (*CategoryList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCategoriesByDescription not implemented")
}
...
func _CategoryService_GetCategoriesByDescription_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CategoryGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).GetCategoriesByDescription(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.CategoryService/GetCategoriesByDescription",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategoriesByDescription(ctx, req.(*CategoryGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCategoriesByDescription",
			Handler:    _CategoryService_GetCategoriesByDescription_Handler,
		},
	},
